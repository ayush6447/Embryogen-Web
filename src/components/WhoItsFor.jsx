...
export default function WhoItsFor() {
  ...
  return (
    <section className="py-28 bg-[#f7f7f7] dark:bg-[#111111]" id="who-its-for" ref={ref}>
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          <span className="section-badge mb-5 inline-flex">{whoItsFor.badge}</span>
